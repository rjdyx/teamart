            ...
            <form class="form-horizontal" action="{{url('admin/user/agent')}}/{{$data->id}}" method="POST" name="userForm">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="name" class="form-control" id="name" placeholder="请输入用户名" value="{{$data->name}}" onblur="validname('name', '用户名', this.value, 'user')" oninput="validname('name', '用户名', this.value, 'user')">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="realname" class="form-control" id="realname" placeholder="请输入姓名" value="{{$data->realname}}" oninput="validrealname('realname', this.value)" onblur="validrealname('realname', this.value)">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="email" name="email" class="form-control" id="email" placeholder="请输入邮箱" value="{{$data->email}}" onblur="validemail('email', this.value)" oninput="validemail('email', this.value)">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="phone" class="form-control" id="phone" placeholder="请输入手机号" value="{{$data->phone}}" oninput="validphone('phone', this.value)" onblur="validphone('phone', this.value)">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <div class="input-group date">
                      ...
                      <input type="text" value="{{$data->birth_date}}" class="form-control pull-right" id="datepicker" name="birth_date" oninput="validbirth_date('birth_date', '出生日期', this.value)" onblur="validbirth_date('birth_date', '出生日期', this.value)">
                    </div>
                    <!-- /.input group -->
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="password" name="password" class="form-control" id="password" placeholder="不输入密码则不修改" onblur="validpassword('password', this.value, false)" oninput="validpassword('password', this.value, false)">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="password" class="form-control" id="repassword" placeholder="若登录密码未输入，则确认密码无效" onblur="validrepassword('repassword', this.value, false)" oninput="validrepassword('repassword', this.value, false)">
                  </div>
