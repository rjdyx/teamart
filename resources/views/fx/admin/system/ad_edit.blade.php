    ...
    <script>
      ...
      $(function () {
        ...
        $('#desc').on('blur input', function () {
          _valid.desc('desc', '广告描述', $(this).val(), 255, false)
        })
        $('#url').on('blur input', function () {
          _valid.desc('url', '链接', $(this).val(), 255, false)
        })
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-success">
            ...
            <form class="form-horizontal" action="{{url('admin/system/ad')}}/{{$data->id}}" method="POST" name="listForm" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="box-body">
                  ...
                  <div class="col-sm-4">
                    <select name="position" class="form-control" id="position">
                      <option value="">-请选广告展示位置-</option>
                        <option value="index" @if($data->position == 'index') selected @endif>首页</option>
                    </select>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name="state" class="form-control" id="state">
                        <option value="1" @if($data->state) checked @endif>开启</option>
                        <option value="0" @if(!$data->state) checked @endif>关闭</option>
                    </select>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="title" value="{{$data->title}}" class="form-control" id="title" placeholder="请输入广告标题">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="desc" value="{{$data->desc}}" class="form-control" id="desc" placeholder="请输入商品描述">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="url" value="{{$data->url}}" class="form-control" id="url" placeholder="请输入广告链接">
                  </div>
