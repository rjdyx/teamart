   ...
   <div class="content-wrapper">
    ...
    <div id="agentRole">
      ...
      <section class="content-header">
        <h1 style="cursor: pointer;">
          ...
          <a href="#"><small class="fa_skin"><i class="fa fa-angle-right" style="margin-right: 4px"></i>广告管理</small></a>
        </h1>
      </section>
    ...
    <div id="addAgent">
      ...
      <section class="content-header">
        <h1 style="cursor: pointer;">
          <a href="#" style="color: #000"><i class="fa fa-home fa_skin" style="margin-right:4px"></i>系统管理</a>
          <a href="#"><small class="fa_skin"><i class="fa fa-angle-right" style="margin-right: 4px"></i>新建广告</small></a>
        </h1>
      </section>
