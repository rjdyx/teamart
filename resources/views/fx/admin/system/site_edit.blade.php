              ...
              <form action="{{url('admin/system/site')}}/{{$site->id}}" method="post" class="form-horizontal">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="name"  value="{{$site->name}}" class="form-control" id="name" placeholder="请输入站点名称">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" name="longitude"  value="{{$site->longitude}}" class="form-control" id="longitude" placeholder="请输入经度">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text"  value="{{$site->latitude}}" name="latitude" class="form-control" id="latitude" placeholder="请输入纬度">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="user" class="form-control" id="user" placeholder="请输入联系人"  value="{{$site->user}}">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="phone" class="form-control" id="phone" placeholder="请输入联系电话"  value="{{$site->phone}}">
                    </div>
