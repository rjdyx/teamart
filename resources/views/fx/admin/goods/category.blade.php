...
<div class="content-wrapper">
    ...
    <div id="agentRole">
      ...
      <section class="content-header">
        <h1 style="cursor: pointer;">
          ...
          <small style="color: #00a65a"><i class="fa fa-angle-right" style="margin-right: 4px"></i>商品分类</small>
        </h1>
      </section>
    ...
    <div id="addAgent">
      ...
      <section class="content-header">
        <h1 style="cursor: pointer;">
          <i class="fa fa-home" style="color: #00a65a;margin-right:4px"></i>商品管理
          <small style="color: #00a65a"><i class="fa fa-angle-right" style="margin-right: 4px"></i>新增商品列表</small>
        </h1>
      </section>
