    ...
    <div id="agentRole">
      ...
      <section class="content-header">
        <h1 style="cursor: pointer;">
          ...
          <small style="color: #00a65a"><i class="fa fa-angle-right" style="margin-right: 4px"></i>商品规格</small>
        </h1>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box box-success">
              <div class="box-header">
                ...
                <div class="box-tools">
                  <button type="button" class="btn btn-block btn-success btn-sm" id="addUser">新建规格</button>
                </div>
              </div>
              <!-- /.box-header -->
