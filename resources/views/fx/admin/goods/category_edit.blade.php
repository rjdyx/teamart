      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box box-success">
            ...
            <form class="form-horizontal" action="{{url('admin/goods/category')}}/{{$data->id}}" method="POST">
              {{ csrf_field() }}
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="name" class="form-control" id="inputEmail3" placeholder="请输入分类名称" value="{{$data->name}}">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">分类描述</label>
                  <div class="col-sm-4">
                    <input type="text" name="desc" class="form-control" id="inputEmail3" placeholder="请输入分类描述" value="{{$data->desc}}">
                  </div>
                </div>
                <div class="form-group">
