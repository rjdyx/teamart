    ...
    <div id="agentRole">
      ...
      <section class="content-header">
        <h1 style="cursor: pointer;">
          ...
          <a href="#"><small class="fa_skin"><i class="fa fa-angle-right" style="margin-right: 4px"></i>优惠券</small></a>
        </h1>
      </section>
          ...
          <div class="col-xs-12">
            <div class="box box-success">
              <div class="box-header">
                ...
                <div class="box-tools">
                  <button type="button" class="btn btn-block btn-success btn-sm" id="addUser">新建优惠</button>
                </div>
              </div>
              <!-- /.box-header -->
