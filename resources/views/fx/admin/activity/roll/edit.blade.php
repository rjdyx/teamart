      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-success">
            ...
            <form class="form-horizontal" name="rollForm" action="{{url('admin/activity/roll')}}/{{$cheap->id}}" method="POST">
              {{ csrf_field() }}
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="name" class="form-control" id="name" placeholder="请输入优惠券名称" value="{{$cheap->name}}">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="number" name="full" class="form-control" id="full" placeholder="请输入满金额" value="{{$cheap->full}}">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="number" name="cut" class="form-control" id="cut" placeholder="请输入减金额" value="{{$cheap->cut}}">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="number" name="amount" class="form-control" id="amount" placeholder="请输入优惠券数量" value="{{$cheap->amount}}">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select name="range" class="form-control">
                        <option value="0" @if($cheap->range == 0) selected @endif>-- 全部 --</option>
                        <option value="1" @if($cheap->range == 1) selected @endif>-- 代理商 --</option>
                        <option value="2" @if($cheap->range == 2) selected @endif>-- 普通会员 --</option>
                    </select>
                    <span class="col-sm-4 text-danger form_error" id="indate_txt"></span>
                  </div>
                </div>
<!--                 <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="desc" class="form-control" id="desc" placeholder="请输入优惠券描述" value="{{$cheap->desc}}">
                  </div>
