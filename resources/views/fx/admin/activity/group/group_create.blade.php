	...
	<div class="row">
		...
		<div class="col-xs-12">
			<div class="box box-success">
				...
				<!-- /.box-header -->
				<!-- form start -->
				<form class="form-horizontal" action="{{url('admin/activity/group')}}" method="POST" name="activity_form">
				{{ csrf_field() }}
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group date">
									...
									<input type="date" class="form-control pull-right" id="date_start" name="date_start">
								</div>
								<!-- /.input group -->
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group date">
									...
									<input type="date" class="form-control pull-right" id="date_end" name="date_end">
								</div>
								<!-- /.input group -->
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="price" placeholder="请输入团购价数额" name="price">
							</div>
						</div>
						<div class="form-group">
