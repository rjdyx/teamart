...
@section('script')
    ...
    <script>
        ...
        //以下代码块是加载完成后才能执行
        $(function () {
            var url = 'application/information/list';//默认
        ...
        function requestfunction(url) {
            ...
            // console.log('http://'+window.location.host+'/home/user/'+url);
            ajax('get','http://'+window.location.host+'/home/user/'+url)
                .then(function (res) {
                    // console.log(url);
                    if(res.length){
                        //先对其进行清空
                        ...
                        $.each(res,function (index,value) {
                            ...
                            if(url == 'application/information/list') {
                                ...
                                let href = '/home/user/secondary/dealer/edit/'+id;
...
@section('content')
    ...
    <div class="container useredit userassets relative">
        ...
        <div class="userassets_content mt-20 w-100" style="overflow:hidden;">
            <ul id="listmenu">
                <li class="menu-check" id="applicationlist">申请列表</li>
                <li id="invitelist">邀请列表</li>
            </ul>
            <div class="userassets_list"></div>
        </div>
        <a href="{{url('/home/user/secondary/dealer/add')}}" class="chayefont bottom_btn white txt-c block fz-18 J_submit"><div>经销商申请</div></a>
